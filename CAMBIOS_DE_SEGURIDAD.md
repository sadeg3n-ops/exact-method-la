...
- Hoy existe fallback hardcoded de Calendly; conviene externalizarlo a variables antes de entregar a cliente final.
- No hay backend protegido de leads.
- Sustituir placeholder de WhatsApp antes de tráfico real.
