...
const TOASTS = [
  { name: "Carlos", action: "just booked his assessment", time: "2 min ago" },
  { name: "David", action: "completed his weekly check-in", time: "18 min ago" },
  { name: "Miguel", action: "received his nutrition adjustment", time: "1 hour ago" },
  { name: "Javier", action: "started week 1", time: "7 min ago" }
]
