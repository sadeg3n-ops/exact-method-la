...
export function FooterSection({ onCtaClick }: FooterSectionProps) {
  const navLinks = [
    { href: "#resultados", label: "Process" },
    { href: "#precio", label: "Program" },
    { href: "#faq", label: "FAQ" },
  ]
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground mb-5 md:mb-8 text-balance leading-[1.02]">
              Book the assessment and{" "}
              <span className="text-primary">get clarity on your next step</span>
            </h2>

            <p className="text-lg md:text-xl text-muted-foreground mb-8 md:mb-12 max-w-2xl mx-auto text-pretty">
              We look at your starting point, what is holding you back, and whether it makes sense to work together.
            </p>
            ...
            <p className="text-sm md:text-base text-muted-foreground mt-5">
              15 min. Online. Free. If it is not a fit, I will tell you.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="max-w-xs md:max-w-none">
              <a href="#" className="flex items-center justify-center md:justify-start gap-2 mb-4">
                ...
                <span className="text-lg font-bold text-foreground">
                  Exact <span className="text-primary">Method</span>
                </span>
              </a>
              <p className="text-muted-foreground/80 text-sm max-w-xs mx-auto md:mx-0">
                Training and nutrition with structure, follow-up, and real adjustments so you can progress without wasting time.
              </p>
            </div>
          ...
          <div className="mt-10 pt-8 border-t border-border/60 text-center">
            <p className="text-sm text-muted-foreground/75">
              © {new Date().getFullYear()} Exact Method. All rights reserved.
            </p>
          </div>
        </div>
      </div>
