...
## Objetivo
Crear una copia offline, limpia y fácil de restaurar de **Exact Method LA** para guardarla en un pendrive o disco externo.
...
```bash
cd "/Users/antonio/Documents/3. Webs/metodo-exacto-valuation-en"
...
2. Crea una carpeta con nombre claro, por ejemplo: `Exact Method LA-copia-seguridad-2026-04-01`.
...
1. Verifica checksums:
   ```bash
   cd /ruta/al/pendrive/Exact Method LA-copia-seguridad-2026-04-01
